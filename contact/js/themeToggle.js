...
function updateTheme() {
  ...
  if (modeCookie) {
    ...
    var contactTitel = document.querySelector('.contact_titel');
    contactTitel.style.color = modeCookie === 'dark' ? '#ffffff' : '#282828';
...
function toggleTheme() {
  ...
  themeIcon.alt = themeIcon.alt.includes('Dunkelmodus') ? 'Hellmodus' : 'Dunkelmodus';
  ...
  var contactTitel = document.querySelector('.contact_titel');
  contactTitel.style.color = document.body.classList.contains('dunkelmodus') ? '#ffffff' : '#282828';

  var ellipse = document.querySelector('.ellipse-image');
  if (ellipse.src.includes('Ellipse-Hell.png')) {
    ellipse.src = ellipse.src.replace('Ellipse-Hell.png', 'Ellipse-Dunkel.png');
  } else if (ellipse.src.includes('Ellipse-Dunkel.png')) {
    ellipse.src = ellipse.src.replace('Ellipse-Dunkel.png', 'Ellipse-Hell.png');
  }
...
// Aktualisieren des Themes, wenn das Dropdown-Menü geändert wird
var dropdownMenu = document.querySelector('.dropdown-menu');
